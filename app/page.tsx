...
const categories = [
  ...
  { name: 'Rumah', note: 'Biar rumah makin nyaman', image: '/collection-home-v1.jpg', size: 'lg:col-span-1' },
];
...
export default function Home() {
  return <main className="home-page overflow-hidden bg-[#fbfbfc] text-[#0b0b0e]">
    ...
    <section className="relative isolate overflow-hidden border-b border-[#ececef] bg-[#f4f0ff] px-4 sm:px-6">
      ...
      <div className="relative mx-auto grid min-h-[620px] max-w-[1240px] lg:min-h-[690px] lg:grid-cols-[1.03fr_.97fr]">
        <div className="relative z-20 flex flex-col justify-center py-14 lg:py-20">
          <p className="flex items-center gap-2 text-[9px] font-black uppercase tracking-[.14em] text-[#704bfd]"><Sparkles size={14}/> NEMU Marketplace buat seller Indonesia</p>
          <h1 className="mt-5 max-w-[720px] font-[var(--font-display)] text-[43px] font-black leading-[1.01] tracking-[-.06em] sm:text-7xl sm:leading-[.98] lg:text-[76px]">Produkmu masuk NEMU.<br/><span className="text-[#704bfd]">Tokomu langsung siap.</span></h1>
          <p className="mt-6 max-w-[650px] text-base font-medium leading-8 text-[#5a5a66]">Upload produk sekali. Barangmu tampil di NEMU Marketplace sekaligus di website tokomu sendiri. Konten, promo, pembayaran, dan kiriman juga sudah disiapkan—kamu tinggal fokus jualan.</p>
          <div className="mt-8 grid grid-cols-2 gap-3 sm:flex sm:flex-wrap"><a className="col-span-2 inline-flex w-full items-center justify-center gap-3 rounded-full bg-[#704bfd] px-6 py-4 text-[10px] font-black text-white shadow-[0_12px_28px_rgba(84,54,190,.24)] transition hover:-translate-y-1 sm:w-auto" href="#jadwal-onboarding"><Store size={17}/> Mulai jualan di NEMU</a><a className="inline-flex w-full items-center justify-center gap-2 rounded-full border border-[#dcdce0] bg-white px-3 py-4 text-[9px] font-black text-[#704bfd] transition hover:-translate-y-1 sm:w-auto sm:gap-3 sm:px-6 sm:text-[10px]" href="#fitur-seller"><Sparkles size={16}/> Lihat yang kamu dapat</a><a className="inline-flex w-full items-center justify-center gap-2 rounded-full border border-[#cfc3ff] bg-[#ede8ff] px-3 py-4 text-[9px] font-black text-[#704bfd] transition hover:-translate-y-1 hover:bg-white sm:w-auto sm:gap-3 sm:px-6 sm:text-[10px]" href="#download-app"><Smartphone size={16}/> Download aplikasi</a></div>
          <div className="mt-10 grid max-w-[680px] gap-5 border-t border-[#dcdce0] pt-6 sm:grid-cols-2"><div><p className="text-[8px] font-black uppercase tracking-[.14em] text-[#704bfd]">Produkmu makin kelihatan</p><p className="mt-2 text-[10px] leading-6 text-[#5a5a66]">Tampil di marketplace dan punya link toko sendiri yang tinggal dibagikan.</p></div><div className="border-t border-[#dcdce0] pt-5 sm:border-l sm:border-t-0 sm:pl-6 sm:pt-0"><p className="text-[8px] font-black uppercase tracking-[.14em] text-[#704bfd]">Mulai tanpa takut rugi</p><p className="mt-2 text-[10px] leading-6 text-[#5a5a66]">Coba semua yang penting buat jualan. Bayar setelah tokomu pecah telur.</p></div></div>
        </div>
    ...
    <section className="relative overflow-hidden bg-white px-4 py-20 sm:px-6 lg:py-28" id="fitur-seller" aria-labelledby="seller-tools-heading">
      ...
      <div className="mx-auto max-w-[1240px]">
        <div className="grid gap-8 lg:grid-cols-[.72fr_1.28fr] lg:items-end">
          <div><p className="text-[9px] font-black uppercase tracking-[.15em] text-[#704bfd]">Semua buat jualan, sudah siap</p><h2 id="seller-tools-heading" className="mt-3 max-w-[600px] text-4xl font-black leading-[.98] tracking-[-.05em] sm:text-5xl">Dari upload produk sampai barang dikirim.</h2></div>
          <div className="lg:pb-1"><p className="max-w-2xl text-sm leading-7 text-[#6b6b75]">Nggak perlu buka banyak aplikasi. NEMU bantu bikin toko, rapihin produk, siapkan konten, jalankan promo, terima pembayaran, sampai atur pengiriman.</p><a className="mt-5 inline-flex items-center gap-2 text-[9px] font-black text-[#704bfd]" href="#jadwal-onboarding">Mulai pakai NEMU <ArrowRight size={14}/></a></div>
        </div>
        ...
        <div className="mt-10 overflow-hidden rounded-[30px] border border-[#dcd6e7] bg-[#f7f4ff] shadow-[0_30px_80px_rgba(47,30,96,.11)]">
          <div className="flex items-center justify-between gap-4 border-b border-[#2f2938] bg-[#17131f] px-5 py-4 text-white sm:px-7">
            <div className="flex items-center gap-3"><span className="size-2.5 rounded-full bg-[#ff715b]"/><span className="size-2.5 rounded-full bg-[#ffd65a]"/><span className="size-2.5 rounded-full bg-[#bdf86b]"/><span className="ml-2 text-[8px] font-black uppercase tracking-[.13em] text-white/65">Isi toko seller NEMU</span></div>
          ...
          <div className="hidden overflow-x-auto bg-white md:block">
            <table className="w-full min-w-[900px] border-collapse text-left">
              ...
              <thead><tr className="border-b border-[#e4e0eb] bg-[#f7f4ff]"><th className="w-[30%] px-7 py-5 text-[8px] font-black uppercase tracking-[.13em] text-[#704bfd]" scope="col">Yang kamu dapat</th><th className="w-[37%] px-7 py-5 text-[8px] font-black uppercase tracking-[.13em] text-[#704bfd]" scope="col">Gampangnya gimana</th><th className="px-7 py-5 text-[8px] font-black uppercase tracking-[.13em] text-[#704bfd]" scope="col">Bikin tokomu jadi</th></tr></thead>
    ...
    <section className="relative overflow-hidden border-y border-[#e8e3ef] bg-[#f7f5fb] px-4 py-16 sm:px-6 lg:py-24" aria-labelledby="seller-dashboard-heading">
      ...
      <div className="relative mx-auto max-w-[1240px]">
        <div className="grid gap-7 lg:grid-cols-[.82fr_1.18fr] lg:items-end">
          <div><p className="text-[9px] font-black uppercase tracking-[.15em] text-[#704bfd]">Di dashboard seller NEMU</p><h2 id="seller-dashboard-heading" className="mt-3 max-w-[580px] text-4xl font-black leading-[.98] tracking-[-.05em] sm:text-5xl">Konten jalan.<br/><span className="text-[#704bfd]">Promo dan kiriman ikut jalan.</span></h2></div>
          <div className="lg:pb-1"><p className="max-w-2xl text-sm leading-7 text-[#625d6d]">Dari satu dashboard, kamu bisa bikin materi promosi, menyiapkan postingan, mengatur gratis ongkir, dan memilih kurir. Nggak perlu pindah-pindah aplikasi.</p><a className="mt-5 inline-flex items-center gap-2 text-[9px] font-black text-[#704bfd]" href="#jadwal-onboarding">Mulai pakai dashboard NEMU <ArrowRight size={14}/></a></div>
        </div>
        ...
        <div className="mt-14 border-t border-[#ddd7e8] pt-10">
          <div className="grid gap-5 lg:grid-cols-[.76fr_1.24fr] lg:items-end">
            <div><p className="text-[9px] font-black uppercase tracking-[.15em] text-[#704bfd]">Contoh hasil video</p><h3 className="mt-3 max-w-[520px] text-3xl font-black leading-[1.02] tracking-[-.045em] sm:text-4xl">Dari satu foto,<br/><span className="text-[#704bfd]">jadi video siap posting.</span></h3></div>
    ...
    <section className="relative overflow-hidden bg-[#f5f1ff] px-4 py-16 sm:px-6 lg:py-24" aria-labelledby="official-seller-heading">
      ...
      <div className="relative mx-auto grid max-w-[1240px] gap-10 lg:grid-cols-[.72fr_1.28fr] lg:items-center">
        <div>
          ...
          <h2 id="official-seller-heading" className="mt-3 max-w-[520px] text-4xl font-black leading-[.98] tracking-[-.05em] sm:text-5xl">Tokomu kelihatan resmi.<br/><span className="text-[#704bfd]">Link-nya tinggal dibagi.</span></h2>
    ...
    <section className="px-4 py-20 sm:px-6 lg:py-28" aria-labelledby="buyer-heading">
      <div className="mx-auto max-w-[1240px]"><div className="grid gap-8 lg:grid-cols-[.75fr_1.25fr] lg:items-end"><div><p className="text-[9px] font-black uppercase tracking-[.15em] text-[#704bfd]">Isi NEMU Marketplace</p><h2 id="buyer-heading" className="mt-3 text-4xl font-black leading-[.98] tracking-[-.05em] sm:text-5xl">Sudah ada yang jual ini di NEMU.</h2></div><p className="max-w-xl text-sm leading-7 text-[#6b6b75] lg:ml-auto">Lagi cari fashion, gadget, beauty, atau barang buat rumah? Pilih kategorinya, lalu lihat produk dari seller NEMU.</p></div>
    ...
    <section className="border-y border-[#e6e0f2] bg-[#f7f4ff] px-4 py-20 sm:px-6 lg:py-24" id="produk" aria-labelledby="trending-heading"><div className="mx-auto max-w-[1240px]"><div className="flex flex-col justify-between gap-5 sm:flex-row sm:items-end"><div><p className="text-[9px] font-black uppercase tracking-[.15em] text-[#704bfd]">Baru dari seller NEMU</p><h2 id="trending-heading" className="mt-2 text-4xl font-black tracking-[-.055em] sm:text-5xl">Produk baru yang siap kamu lihat.</h2><p className="mt-3 max-w-xl text-sm leading-7 text-[#6b6b75]">Pilihan terbaru dari seller yang sudah buka toko di NEMU.</p></div><Link className="inline-flex w-fit items-center gap-2 text-[9px] font-black text-[#704bfd]" href="/shop">Lihat semua produk <ArrowRight size={14}/></Link></div>
      <div className="mt-10 flex snap-x gap-4 overflow-x-auto pb-4 lg:grid lg:grid-cols-6 lg:overflow-visible lg:pb-0">{products.map(product=><article className="group min-w-[174px] snap-start overflow-hidden rounded-[24px] border border-[#e3ddec] bg-white shadow-[0_16px_36px_rgba(58,39,110,.08)] sm:min-w-[210px] lg:min-w-0" key={product.name}><div className="relative aspect-square overflow-hidden bg-[#f3f3f7]"><span className="absolute inset-0 bg-cover bg-center bg-no-repeat transition duration-500 group-hover:scale-105" role="img" aria-label={product.name} style={{backgroundImage:"url('/product-sprite-a-v1.png')",backgroundSize:'300% 200%',backgroundPosition:product.position}}/><span className="absolute left-3 top-3 rounded-full bg-[#704bfd] px-3 py-1.5 text-[7px] font-black text-white">{product.badge}</span></div><div className="p-4"><h3 className="line-clamp-2 min-h-9 text-[10px] font-black leading-4">{product.name}</h3><strong className="mt-2 block text-base">{product.price}</strong>{product.old&&<small className="mt-1 block text-[8px] text-[#84848f] line-through">{product.old}</small>}<Link className="mt-3 inline-flex items-center gap-1 text-[8px] font-black text-[#704bfd]" href="/shop">Buka produk <ArrowRight size={11}/></Link></div></article>)}</div></div></section>
    ...
    <section className="relative overflow-hidden border-y border-[#e6e0f2] bg-[#f5f1ff] px-4 py-16 sm:px-6 lg:py-24" id="snap-list-sell" aria-labelledby="snap-list-sell-heading">
      ...
      <div className="relative mx-auto grid max-w-[1240px] gap-12 lg:grid-cols-[.72fr_1.28fr] lg:items-center">
        <div className="relative z-20">
          ...
          <h2 id="snap-list-sell-heading" className="mt-4 max-w-[470px] text-4xl font-black leading-[.98] tracking-[-.05em] sm:text-5xl">Foto produknya.<br/><span className="text-[#704bfd]">NEMU rapihin. Tinggal tayang.</span></h2>
          <p className="mt-5 max-w-[460px] text-sm leading-7 text-[#625d6d]">Jepret produknya dan isi harga. NEMU bantu bikin nama, deskripsi, dan kategori. Kamu tinggal cek sebelum tayang.</p>
    ...
    <section className="bg-white px-4 py-20 sm:px-6 lg:py-28" aria-labelledby="faq-heading"><div className="mx-auto grid max-w-[1240px] overflow-hidden rounded-[34px] border border-[#dcdce0] lg:grid-cols-[.72fr_1.28fr]"><div className="relative overflow-hidden bg-[#704bfd] p-8 text-white sm:p-12"><span className="absolute -bottom-28 -left-24 size-[330px] rounded-full border-[58px] border-white/10"/><div className="relative"><span className="grid size-14 place-items-center rounded-full bg-white text-[#704bfd]"><Sparkles size={24}/></span><p className="mt-10 text-[9px] font-black uppercase tracking-[.15em] text-[#e7dfff]">Yang sering ditanyain</p><h2 id="faq-heading" className="mt-3 text-4xl font-black leading-[.98] tracking-[-.05em] sm:text-5xl">Biar nggak mikir sendirian.</h2><p className="mt-5 max-w-sm text-sm leading-7 text-white/75">Klik pertanyaan yang masih bikin bingung. Kalau mau cari barang, cukup ketik cirinya di Mode AI.</p><Link className="mt-8 inline-flex items-center gap-2 rounded-full bg-white px-5 py-3 text-[9px] font-black" style={{color:'#704bfd'}} href="/ai-mode"><span style={{color:'#704bfd'}}>Tanya Mode AI</span><ArrowRight style={{color:'#704bfd'}} size={14}/></Link></div></div><div className="bg-[#fbfbfc] p-6 sm:p-10">{faq.map(([question,answer],index)=><details className="faq-item group mb-3 rounded-[20px] border border-[#e4e0eb] bg-white px-5 open:border-[#b9a8ff] open:shadow-[0_10px_24px_rgba(61,39,130,.08)]" key={question} open={index===0}><summary className="flex cursor-pointer list-none items-center justify-between gap-5 py-5 text-[11px] font-black"><span className="flex items-center gap-3"><b className="text-[8px] text-[#704bfd]">0{index+1}</b>{question}</span><CirclePlus className="shrink-0 text-[#704bfd] transition group-open:rotate-45" size={20}/></summary><p className="border-t border-[#ececef] pb-5 pt-4 text-[10px] leading-6 text-[#6b6b75]">{answer}</p></details>)}</div></div></section>
    <Footer/>
  </main>;
}
